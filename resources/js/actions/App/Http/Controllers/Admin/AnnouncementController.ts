...
* @see app/Http/Controllers/Admin/AnnouncementController.php:15
...
* @see app/Http/Controllers/Admin/AnnouncementController.php:60
...
* @see app/Http/Controllers/Admin/AnnouncementController.php:70
* @route '/admin/announcements/{announcement}'
*/
...
* @see app/Http/Controllers/Admin/AnnouncementController.php:87
* @route '/admin/announcements/{announcement}'
*/
...
/**
* @see \App\Http\Controllers\Admin\AnnouncementController::publish
* @see app/Http/Controllers/Admin/AnnouncementController.php:98
* @route '/admin/announcements/{announcement}/publish'
*/
...
publish.definition = {
    methods: ["post"],
    url: '/admin/announcements/{announcement}/publish',
} satisfies RouteDefinition<["post"]>
...
const AnnouncementController = { index, create, store, show, edit, update, destroy, publish }
