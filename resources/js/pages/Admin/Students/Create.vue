...
// Watch for year changes to reset specialization and track
...
// Watch for specialization changes to reset track
    ...
    <AppLayout>
        ...
        <div class="py-12">
            <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-6">
                <div>
                    <h2 class="text-2xl font-semibold text-gray-900">Add New Student</h2>
                    <p class="mt-1 text-sm text-gray-600">
                        Create a student account. Password will be auto-generated and sent via email.
                    </p>
                </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Enter student details and academic information</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div>
                                ...
                                <Input
                                    ...
                                    type="email"
                                    required
                                    placeholder="e.g., ahmed.elmansouri@uca.ac.ma"
                                />
