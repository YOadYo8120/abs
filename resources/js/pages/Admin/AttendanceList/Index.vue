...
const updateFilter = () => {
    router.get('/admin/attendance-list', {
...
const generatePDF = () => {
    ...
    window.location.href = `/admin/attendance-list/generate?${queryString}`
            ...
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        Generate a printable PDF attendance list for any class session
                    </p>
                </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Choose the year, semester, module, week, and day</CardDescription>
                    </CardHeader>
                    <CardContent class="space-y-6">
                        ...
                        <Alert v-if="selectedYear >= 3 && !selectedSpecialization">
                            <AlertDescription>
                                Please select a specialization to view modules for Year {{ selectedYear }}
                            </AlertDescription>
                        </Alert>
