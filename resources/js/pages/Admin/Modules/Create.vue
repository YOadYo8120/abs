...
import { index as modulesIndex, store as modulesStore } from '@/routes/admin/modules';
        ...
        <div class="container mx-auto max-w-2xl py-8">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Add a new course module to the system</CardDescription>
                </CardHeader>
                <CardContent>
